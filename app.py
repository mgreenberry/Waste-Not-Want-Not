...
def modifies():
    ...
    return render_template("home.html", modifies=modifies)
...
"""
@app.route("/")
@app.route("/food")  # is this the right route?
def get_food():
    foods = mongo.db.food.find()
    return render_template("home.html", foods=foods)
...
@app.route("/home")
def home():
    home = list(mongo.db.food.find().sort('use_by_date', 1))
